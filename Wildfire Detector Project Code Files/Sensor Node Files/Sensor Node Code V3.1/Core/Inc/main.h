...
#define V_GAS_Pin GPIO_PIN_6
#define V_GAS_GPIO_Port GPIOA
#define V_REF_OUT_IN_Pin GPIO_PIN_7
...
#define RESET_SHT31_Pin GPIO_PIN_8
#define RESET_SHT31_GPIO_Port GPIOA
#define SWDIO_Pin GPIO_PIN_13
#define SWDIO_GPIO_Port GPIOA
#define SWCLK_Pin GPIO_PIN_14
#define SWCLK_GPIO_Port GPIOA
#define RESET_RFM9X_Pin GPIO_PIN_15
#define RESET_RFM9X_GPIO_Port GPIOA
#define SPI3_NSS_Pin GPIO_PIN_2
#define SPI3_NSS_GPIO_Port GPIOD
#define DIO0_RFM9X_Pin GPIO_PIN_4
#define DIO0_RFM9X_GPIO_Port GPIOB
#define BATT_IND_Pin GPIO_PIN_5
#define BATT_IND_GPIO_Port GPIOB
